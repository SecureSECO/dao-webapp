        ...
        <form className="space-y-2">
          ...
          <div className="flex p-4 h-24 bg-popover text-popover-foreground rounded-md border border-input">
            ...
            <div className="flex flex-col gap-1 items-end">
              ...
              <MaxButton address={address} />
            </div>
          </div>
          {/* Swap button */}
          <div className="absolute top-1/2 -translate-y- left-1/2 -translate-y-5 -translate-x-1/2">
            <Button
              onClick={() => {
                setSwap(!swap);
              }}
...
const MaxButton = ({ address }: { address: `0x${string}` | undefined }) => {
  return (
